...
namespace Data_Access_Layer
{
    public class DALMission
    {
        ...
        {
            return _cIDbContext.Missions.Where(ml => ml.IsDeleted == false)
                .ToList();
        }
        ...
        public List<Missions> ClientSideMissionList(int userid)
        {
            ...
            //var missionApplicationList = MissionApplicationList();

            //var maList = missionApplicationList.Where(ma => ma.UserId == userid).ToList().Count < 0;
